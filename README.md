...
| v2.0.2 | **Samsung Galaxy S26 Ultra (SM8850) NPU models** | Added SM8550 ("Snapdragon 8 Elite Gen 5") allowlist keys across the new Gemma 3 1B and 270M entries, so dedicated NPU models now appear and run on the S26 Ultra. |
